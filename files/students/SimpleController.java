...
public class SimpleController {
    ...
    // instance variables
    private BaseList students;
    private BaseList courses;
    ...
    public void saveStudentsAndEnrollments() throws FileNotFoundException {
        ...
        for(int i = 0; i < students.size(); i++) {
            ...
            // get the courses
            BaseList courses = s.getCourseList();
    ...
    public StudentListModel getStudentListModel() {
        return new StudentListModel( (StudentList)this.students );
    }
    
    public StudentListModel getStudentListModel(String key) {
        return new StudentListModel( ((StudentList)this.students).query(key) );
    }
    
    public CourseListModel getCourseListModel() {
        return new CourseListModel( (CourseList)this.courses );
    }
