 ...
 */
public class Course implements Comparable, Searchable<Course> {
    ...
    public boolean isMatch(String key) {
        ...
        return this.getCode().toLowerCase().contains(key) || 
            this.getTitle().toLowerCase().contains(key);
    }
