...
public abstract class Student implements Searchable {
    ...
    */
    ...
    public void registerCourse(Course c) throws CreditHourLimitExceededException {
        if( this.getCreditHours() + c.getCreditHour() > 9 )
            throw new CreditHourLimitExceededException();
    ...
    public boolean matchesExact(String key) {
        ...
        return this.getName().toLowerCase().equals( key.toLowerCase() );
    }
